...
const DetailInfo = (props) => {
    ...
    const { data } = useFetch(`https://api.themoviedb.org/3/${props.media_type}/${props.id}?api_key=68d49bbc8d40fff0d6cafaa7bfd48072&append_to_response=external_ids,keywords`);
        ...
        <>
            <section className={styles.detail_info}>
                <div className={`${styles.container_y_1}`}>
                    <div className={styles.social_banner}>
                    ...
                    <div className={styles.state_banner}>
